function rovpilot(name, deps) {
    ...
    deps.io.sockets.on('connection', function (socket) {
        ...
        socket.on('enable_auto_pilot', function(){
            deps.rov.send('enable_auto_pilot()');
            console.log('enable_auto_pilot() sent');
        });

        socket.on('disable_auto_pilot', function(){
            deps.rov.send('disable_auto_pilot()');
            console.log('disable_auto_pilot() sent');
        });
